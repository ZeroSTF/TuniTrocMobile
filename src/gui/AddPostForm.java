...
public class AddPostForm extends BaseForm {
    ...
    public AddPostForm(Resources res) {
        super("Posts", BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
        ...
        addBtn.addActionListener(e -> {
            try {
                ...
                post.setIdUser(SessionManager.getId()); // Set the idUser attribute to the ID of the user from the SessionManager

                ServicePost.getInstance().addPost(post);
                new ListPostForm(res).show();
