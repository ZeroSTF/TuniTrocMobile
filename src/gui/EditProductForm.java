...
public class EditProductForm extends BaseForm{
    ...
    public EditProductForm(Resources res ,Product product) {
        ...
        TextField typeField = new TextField(product.getType(), "Type");
        TextField categorieField = new TextField(product.getCategorie(), "Category");
        TextField nomField = new TextField(product.getNom(), "Name");
        TextField libelleField = new TextField(product.getLibelle(), "Description");
        TextField prixField = new TextField(String.valueOf(product.getPrix()), "Price");
        TextField stockField = new TextField(String.valueOf(product.getStock()), "Stock");
        ...
        saveBtn.addActionListener(e -> {
            try {
              ...
              //  int stock = Integer.parseInt(stockField.getText().trim());
                ...
                ServiceProduct.getInstance().editProduct(product);
                new ListProductForm(res).show();
